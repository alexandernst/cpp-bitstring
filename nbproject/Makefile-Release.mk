...
${OBJECTDIR}/Bits.o: Bits.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bits.o Bits.cpp
...
${TESTDIR}/tests/BitsTests.o: tests/BitsTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BitsTests.o tests/BitsTests.cpp


${TESTDIR}/tests/main.o: tests/main.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/main.o tests/main.cpp
...
${OBJECTDIR}/Bits_nomain.o: ${OBJECTDIR}/Bits.o Bits.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bits_nomain.o Bits.cpp;\
	else  \
